...
export default function MapHans() {
  ...
  // Travado na endemia de Hanseníase
  const [endemiaSelecionada, setEndemiaSelecionada] = useState("hanseniase");
  ...
  // Busca os dados exclusivamente da rota de hanseníase
  useEffect(() => {
    setLoading(true);
    const apiUrl = import.meta.env.VITE_API_URL;
    fetch(`${apiUrl}/api/hans/`)
      .then((res) => {
        if (!res.ok)
          throw new Error("Erro na requisição da API do Mapa de Hanseníase");
        return res.json();
      })
      .then((data) => {
  ...
  useEffect(() => {
    ...
    todosPacientes.forEach((paciente) => {
      ...
      // Soma os casos aglutinados da planilha (nu_notific)
      ...
      if (nomeAreaMapa) {
        ...
        console.warn(
          "UBS de Hanseníase não mapeada para o polígono:",
          nomeUbsOriginal,
        );
      }
    });
          ...
          <div className="relative w-full h-full rounded-xl md:rounded-2xl overflow-hidden border border-slate-200 shadow-sm bg-slate-200 flex-1">
            ...
            {loading ? (
              <div className="flex h-full items-center justify-center">
                {/* Loader Roxo */}
                <Activity className="size-8 text-violet-500 animate-spin" />
              </div>
            ) : (
              <div className="relative w-full h-full">
                ...
                >
                  ...
                  {marcadores.map((place) => (
                    ...
                    >
                      <MarkerContent>
                        {/* Marcador cor violeta para Hanseníase */}
                        <div className="size-5 cursor-pointer rounded-full border-2 border-white bg-violet-500 shadow-lg transition-transform h-6 w-6 hover:scale-110">
