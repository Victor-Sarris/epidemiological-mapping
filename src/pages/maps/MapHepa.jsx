...
export default function MapHepa() {
  ...
  // Busca os dados exclusivamente da rota de hepatite
  useEffect(() => {
    setLoading(true);
    const apiUrl = import.meta.env.VITE_API_URL;
    fetch(`${apiUrl}/api/hepatite/`)
      .then((res) => {
        if (!res.ok)
          throw new Error("Erro na requisição da API do Mapa de Hepatite");
        return res.json();
      })
      .then((data) => {
  ...
  useEffect(() => {
    ...
    todosPacientes.forEach((paciente) => {
      ...
      if (nomeAreaMapa) {
        ...
        console.warn(
          "UBS de Hepatite não mapeada para o polígono:",
          nomeUbsOriginal,
        );
      }
    });
              ...
              <div className="relative w-full h-full">
                ...
                >
                  ...
                  {marcadores.map((place) => (
                    ...
                    >
                      <MarkerContent>
                        {/* Marcador cor âmbar para Hepatite */}
