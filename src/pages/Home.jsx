...
function Home() {
  ...
  return (
    <div className="min-h-screen w-full flex flex-col lg:flex-row relative overflow-hidden bg-transparent">
      ...
      <div className="flex-1 flex flex-col justify-center p-6 sm:p-10 md:p-12 lg:p-16 relative z-10">
      ...
      {/* Lado Direito - Painel de Autenticação / Acesso (Efeito de Vidro mantido) */}
      <div className="w-full lg:w-[480px] bg-white/80 backdrop-blur-lg flex flex-col justify-center p-6 sm:p-10 md:p-12 lg:px-16 lg:py-16 border-t lg:border-t-0 lg:border-l border-slate-200/50 relative z-10 shadow-[0_0_40px_-15px_rgba(0,0,0,0.1)]">
